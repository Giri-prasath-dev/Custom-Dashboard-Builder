const WidgetHeader = ({ title, type, onSettings, onDelete }) => {
  return (
    <div className="flex items-center justify-between px-4 py-2.5 border-b border-gray-100 bg-gray-50/50 rounded-t-xl">
      ...
      <div className="flex items-center gap-1 shrink-0">
        ...
        <button
          onClick={onSettings}
          className="w-7 h-7 flex items-center justify-center text-gray-400 hover:text-primary-600 hover:bg-primary-50 rounded-lg transition-colors cursor-pointer"
          title="Settings"
        >
          <svg 
            xmlns="http://www.w3.org/2000/svg" 
